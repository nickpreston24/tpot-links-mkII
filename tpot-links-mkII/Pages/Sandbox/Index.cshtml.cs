...
public class IndexModel : HighSpeedPageModel
{
    ...
    public async Task<IActionResult> OnPostRecommendations()
    {
        ...
        var recommended_papers = await neo4jrepo.SearchNeo4J<Paper>(query, search_parameters);
        recommended_papers.FirstOrDefault(x => !string.IsNullOrWhiteSpace(x.Title)).Dump("recommendations");

        var users_who_liked_papers = await neo4jrepo.SearchNeo4J<User>(query, search_parameters);
