...
namespace CodeMechanic.Extensions
{
    ...
    public static class StringExtensions
    {
        ...
        public static string ToFormat(this double value, string format = "0.00") =>
            string.Format(value.ToString(), format);

        public static string ToFormat(this float value, string format = "0.00") =>
            string.Format(value.ToString(), format);

        public static string ToFormat(this decimal value, string format = "0.00") =>
            string.Format(value.ToString(), format);

        public static string ToFormat(this DataRow row, string format = "0.00") =>
            string.Format(row.ToString(), format);

      
        public static string ToPlacedDecimalFormat(this decimal value)
        {
            return value.ToString(value % 1 == 0 ? "N0" : "N2"); // Or F0/F2 ;)
        }

        public static decimal RoundTo(this decimal value, int places = 2)
        {
        ...
        // a.k.a 'FormatD'
        public static string FormatAsShortDate(this string text)
        {
            ...
            if (text.IsDate())
            {
                DateTime date = text.ToDateTime().Value;
                if (date.Year < 2000)
                {
                    return "";
                }
        ...
        // a.k.a 'FormatDt'
        public static string FormatAsDateTime(this string date)
        {
            ...
            if (date.IsDate())
            {
                DateTime d2 = date.ToDateTime().Value;
                if (d2.Year < 2000)
                {
                    return "";
                }
                ...
                {
                    return d2.ToShortDateString() + " " + d2.ToLongTimeString();
                }
            }
            else
            {
